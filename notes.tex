...
On Becker's suggestion, I'm going to try out a cosmology-dependent MC relation. Since cosmology is for all fits, what I hope to see is a consistant bias between simulations AND a level of scatter comparable to fixing the mass-concentration relation. I'm going to use \citet{zhao_cosmodepmc}, since they provide an online calculator and code. For now, I'll just download tables corresponding to each cosmology that I need. I'll figure out later how to actually run their code on the fly, if it works. The calculator is at: \url{http://202.127.29.4/dhzhao/mandc.html}.
