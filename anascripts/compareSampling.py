...
for mcr in mcrs:
    ...
    for radrange in radialranges:
        ...
        tight_layout()
        savefig('density_noise2_{0}-{1}_scatter.png'.format(mcr, radrange))
...
sampledens = 3
noisesamplings = ['n{0}_{1}'.format(sampledens, i) for i in range(4)]
...
#        title('MC Relation: {0} RadialRange: {1}'.format(mcr, radrange_trans[radrange]))
#        tight_layout()
#        savefig('noise_{0}-{1}-{2}.png'.format(mcr, radrange, sampling))
#
####
# Scatter
...
#        title('Scatter - MC Relation: {0} Radial Range: {1}'.format(mcr, radrange_trans[radrange]))
#        tight_layout()
#        savefig('noise_{0}-{1}-{2}_scatter.png'.format(mcr, radrange, sampling))
#
#
