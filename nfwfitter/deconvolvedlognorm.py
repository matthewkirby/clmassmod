...
def buildMCMCModel_massconcentration(halos, maxsamples = 2000, sigmapriors = None):
    '''
    ...
    Note: sigmapriors is simply expected by the  rundln.py call.
    '''

    if sigmapriors is not None :
