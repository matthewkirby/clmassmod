...
def calcLensingTerms(density_profile, rmax):
    ...
    table_log_Sigma = np.log(density_profile.surfaceDensity(table_r, interpolate=False))
...
class AnalyticSim(catalog.Catalog):
